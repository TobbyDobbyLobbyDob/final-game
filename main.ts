    ...
    if (UpdateLevels) {
        if (levels == 2) {
            ...
            game.setDialogCursor(img`
                ...
                . . . . . . . . . . . . . . . . 
                `)
            game.showLongText("HAHA Foolish human, you think you can take back your possession that easily? Maybe just maybe, if you can dodge my very difficult rock drop for a few seconds I may give your stuff back. Good luck, you'll need it.", DialogLayout.Bottom)
            mySprite.vy = -50
            if (mySprite.y >= -200) {
                mySprite.vy = 0
            }
